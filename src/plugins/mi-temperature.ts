...
// 	4106 /*0x100A*/: (buffer, offset) => ({ bat: buffer.readUInt8(offset) }), // BATTERY
// 	4109 /*0x100D*/: (buffer, offset) => ({
// 		tmp: buffer.readUInt16LE(offset) / 10,
// 		hum: buffer.readUInt16LE(offset + 2) / 10,
// 	}), // TEMP_HUM
// 	4102 /*0x1006*/: (buffer, offset) => ({ hum: buffer.readUInt16LE(offset) / 10 }), // HUM
// 	4100 /*0x1004*/: (buffer, offset) => ({ tmp: buffer.readUInt16LE(offset) / 10 }), // TEMP
// };
