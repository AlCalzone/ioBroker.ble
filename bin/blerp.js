...
var require_color_name = __commonJS({
  "node_modules/ansi-styles/node_modules/color-name/index.js"(exports, module2) {
    "use strict";
    module2.exports = {
      ...
      postProcessPositionals(t2, e2, s2, i2) {
        ...
        if (a2.error)
          ...
          Object.keys(a2.argv).forEach((i3) => {
            s3.includes(i3) && (e2[i3] || (e2[i3] = a2.argv[i3]), !Object.hasOwnProperty.call(n3, i3) && Object.hasOwnProperty.call(t2, i3) && Object.hasOwnProperty.call(a2.argv, i3) && (Array.isArray(t2[i3]) || Array.isArray(a2.argv[i3])) ? t2[i3] = [].concat(t2[i3], a2.argv[i3]) : t2[i3] = a2.argv[i3]);
          });
        }
      }
      ...
      optionCompletions(t2, e2, s2, i2) {
        if ((i2.match(/^-/) || "" === i2 && 0 === t2.length) && !this.previousArgHasChoices(e2)) {
          ...
          Object.keys(n2.key).forEach((o2) => {
            ...
            r2.includes(o2) || n2.hiddenOptions.includes(o2) || this.argsContainKey(e2, s2, o2, a2) || (this.completeOptionKey(o2, t2, i2), a2 && n2.default[o2] && this.completeOptionKey(`no-${o2}`, t2, i2));
          });
        }
      }
    ...
    var Xt = class {
      ...
      coerce(t2, s2) {
        ...
        return v(this, et, "f").key[t2] = true, v(this, B, "f").addCoerceMiddleware((i2, n2) => {
          let r2;
          return Object.hasOwnProperty.call(i2, t2) ? j(() => (r2 = n2.getAliases(), s2(i2[t2])), (e2) => {
            i2[t2] = e2;
      ...
      locale(t2) {
        return h("[string]", [t2], arguments.length), t2 ? (O(this, G, false, "f"), v(this, ct, "f").y18n.setLocale(t2), this) : (this[_t](), v(this, ct, "f").y18n.getLocale());
      }
      middleware(t2, e2, s2) {
      ...
      parse(t2, e2, s2) {
        ...
        }) : (v(this, nt, "f") && v(this, nt, "f").call(this, v(this, V, "f"), i2, v(this, tt, "f")), this[Nt](), this.parsed = n2, i2);
      }
      parseAsync(t2, e2, s2) {
        ...
        try {
          ...
          if (v(this, J, "f") || (p2 ? (v(this, T, "f") && E(true), o2 = true, this.showHelp("log"), this.exit(0)) : g2 && (v(this, T, "f") && E(true), o2 = true, v(this, pt, "f").showVersion("log"), this.exit(0))), !o2 && v(this, et, "f").skipValidation.length > 0 && (o2 = Object.keys(c2).some((t3) => v(this, et, "f").skipValidation.indexOf(t3) >= 0 && true === c2[t3])), !o2) {
            ...
            if (!m2) {
              ...
              i2 || (d2 = C(c2, this, v(this, B, "f").getMiddleware(), true)), d2 = this[Dt](t3, null != d2 ? d2 : c2), f(d2) && !i2 && (d2 = d2.then(() => C(c2, this, v(this, B, "f").getMiddleware(), false)));
            }
          }
        } catch (t3) {
          if (!(t3 instanceof e))
...
var argv = yargs.env("IOB_BLE").strict().usage("ioBroker.ble scanner process\n\nUsage: $0 [options]").options({
  hciDevice: {
    alias: "-d",
    type: "number",
