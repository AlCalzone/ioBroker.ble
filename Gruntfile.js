...
module.exports = function (grunt) {
    ...
    var author    = grunt.option('author') || 'AlCalzone';
    var email     = grunt.option('email')  || 'd.griesel@gmx.net';
    var fs        = require('fs');
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (fs.existsSync(__dirname + '/admin/ble.png')) {
            fs.renameSync(__dirname + '/admin/ble.png',              __dirname + '/admin/' + newname + '.png');
        }
